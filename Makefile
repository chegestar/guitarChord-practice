...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Fri Feb 10 23:08:02 2012
# Project:  chord.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile chord.pro
#############################################################################
...
$(TARGET): ui_mainwindow.h ui_aboutdialog.h ui_configure.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: chord.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile chord.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/chord1.0.0/ && $(COPY_FILE) --parents mainwindow.h element.h scene.h ui_mainwindow.h list.h aboutdialog.h configure.h .tmp/chord1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp element.cpp list.cpp aboutdialog.cpp configure.cpp .tmp/chord1.0.0/ && $(COPY_FILE) --parents mainwindow.ui aboutdialog.ui configure.ui .tmp/chord1.0.0/ && (cd `dirname .tmp/chord1.0.0` && $(TAR) chord1.0.0.tar chord1.0.0 && $(COMPRESS) chord1.0.0.tar) && $(MOVE) `dirname .tmp/chord1.0.0`/chord1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/chord1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_aboutdialog.cpp moc_configure.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_aboutdialog.cpp moc_configure.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_aboutdialog.h ui_configure.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_aboutdialog.h ui_configure.h
